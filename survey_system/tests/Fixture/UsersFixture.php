...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'pass' => ['type' => 'string', 'length' => 200, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2019-03-04 09:46:56',
                'modified' => '2019-03-04 09:46:56'
            ],
        ];
        parent::init();
    }
